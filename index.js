...
const translations = {
  de: {
    ...
    sect_log_desc: "Erfahrene Staplerfahrer, Kommissionierer und Logistikhelfer zur Absicherung Ihrer gesamten Supply Chain und Lagerprozesse.",
    sec_log_h2: "Lager, Logistik & Versand",
    ...
    sect_ind_desc: "Qualifizierte Produktionshelfer, Maschinenbediener und Facharbeiter für Ihre Fertigungslinien und Montageprozesse.",
    sec_ind_h2: "Industrie & Produktion",
    ...
    home_metal_short: "Geprüfte Schweißer (MIG/MAG/WIG), CNC-Fachkräfte und Elektroinstallateure — qualifiziertes Fachpersonal für Industrieprojekte im In- und Ausland.",
    sec_metal_h2: "Metall- & Elektroindustrie",
    sec_metal_desc1: "Fachkräfte in der Schweißtechnik, CNC-Bearbeitung und Elektroinstallation werden händeringend gesucht. Altintas Personalmanagement rekrutiert zertifizierte Facharbeiter national sowie über unser Partnernetzwerk in Bursa (Türkei) direkt für Ihren Bedarf.",
    sectors_cta_title: "Passgenaues Fachpersonal für Logistik, Produktion & Metallbau",
    sectors_cta_desc: "Ob qualifizierte Logistikhelfer, erfahrene Produktionskräfte oder zertifizierte Schweißer & CNC-Experten — wir stellen Ihnen schnell und rechtssicher die passenden Teams bereit.",
  ...
  tr: {
    ...
    sect_log_desc: "Depo ve tedarik zinciri süreçleriniz için tecrübeli forklift operatörleri, sipariş toplama elemanları ve lojistik kadrosu.",
    sec_log_h2: "Depo, Lojistik & Sevk",
    ...
    sect_ind_desc: "Üretim hatlarınız, montaj ve fabrika operasyonlarınız için nitelikli üretim elemanları ve makine operatörleri.",
    sec_ind_h2: "Endüstri & Üretim",
    ...
    sec_metal_h2: "Metal ve Elektrik Sanayisi",
    sec_metal_desc1: "Kaynak teknolojileri, CNC işleme ve elektrik tesisatı alanlarında sertifikalı uzman bulmak zordur. Altintas Personalmanagement hem Almanya genelinde hem de Bursa (Türkiye) ağımız üzerinden teknik personeli hızla temin eder.",
    sectors_cta_title: "Lojistik, Üretim ve Teknik Sanayi İçin Uzman Kadro",
    sectors_cta_desc: "Depo operatörlerinden fabrika üretim elemanlarına ve sertifikalı kaynakçı/CNC ustalarına kadar — ihtiyacınız olan nitelikli personeli hızlı ve yasal güvenceyle sağlıyoruz.",
    ...
    // Locations Page (standorte.html)
    map_hero_title: "Görev Noktalarımız (Einsatzorte)",
